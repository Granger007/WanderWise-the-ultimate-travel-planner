...
**WanderWise** is a smart travel planning web application built with Flask and MySQL. 🌍 It helps users discover destinations, explore activities, view hotels, and organize trips efficiently — all from a single, user-friendly dashboard.
